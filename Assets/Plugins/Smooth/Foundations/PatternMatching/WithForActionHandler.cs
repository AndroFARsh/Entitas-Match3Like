...
namespace Smooth.Foundations.PatternMatching
{
    public sealed class WithForActionHandler<TMatcher, T1>
    {
        ...
        internal WithForActionHandler(T1 value,
            System.Action<DelegateFunc<T1, bool>, Action<T1>> recorder,
                                      TMatcher matcher)
        {
        ...
        public TMatcher Do(System.Action<T1> action)
        {
            _recorder(x => _values
                .Slinq()
    ...
    {
        private readonly List<Smooth.Algebraics.Tuple<T1, T2>> _values;
        private readonly Action<DelegateFunc<T1, T2, bool>, Action<T1, T2>> _recorder;
        private readonly TMatcher _matcher;

        internal WithForActionHandler(Smooth.Algebraics.Tuple<T1, T2> value,
                                      Action<DelegateFunc<T1, T2, bool>, Action<T1, T2>> recorder,
                                      TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2>> { value };
            _recorder = recorder;
            _matcher = matcher;
        }
    ...
    {
        private readonly List<Smooth.Algebraics.Tuple<T1, T2, T3>> _values;
        private readonly Action<DelegateFunc<T1, T2, T3, bool>, Action<T1, T2, T3>> _recorder;
        private readonly TMatcher _matcher;

        internal WithForActionHandler(Smooth.Algebraics.Tuple<T1, T2, T3> value,
                                      Action<DelegateFunc<T1, T2, T3, bool>, Action<T1, T2, T3>> recorder,
                                      TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2, T3>> { value };
            _recorder = recorder;
            _matcher = matcher;
        }
    ...
    {
        private readonly List<Smooth.Algebraics.Tuple<T1, T2, T3, T4>> _values;
        private readonly Action<DelegateFunc<T1, T2, T3, T4, bool>, Action<T1, T2, T3, T4>> _recorder;
        private readonly TMatcher _matcher;

        internal WithForActionHandler(Smooth.Algebraics.Tuple<T1, T2, T3, T4> value,
                                      Action<DelegateFunc<T1, T2, T3, T4, bool>, Action<T1, T2, T3, T4>> recorder,
                                      TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2, T3, T4>> { value };
            _recorder = recorder;
            _matcher = matcher;
        }

...
namespace Smooth.Foundations.PatternMatching
{
    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, TResult>
    {
        ...
        internal WithForFuncHandler(Smooth.Algebraics.Tuple<T1, T2> value,
                                    Action<DelegateFunc<T1, T2, bool>, DelegateFunc<T1, T2, TResult>> recorder,
                                    TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2>>
            {
                value
            };
            _recorder = recorder;
    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, T3, TResult>
    {
        ...
        internal WithForFuncHandler(Smooth.Algebraics.Tuple<T1, T2, T3> value,
                                    Action<DelegateFunc<T1, T2, T3, bool>, DelegateFunc<T1, T2, T3, TResult>> recorder,
                                    TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2, T3>>
            {
                value
            };
            _recorder = recorder;
    ...
    public sealed class WithForFuncHandler<TMatcher, T1, T2, T3, T4, TResult>
    {
        ...
        internal WithForFuncHandler(Smooth.Algebraics.Tuple<T1, T2, T3, T4> value,
                                    Action<DelegateFunc<T1, T2, T3, T4, bool>, DelegateFunc<T1, T2, T3, T4, TResult>> recorder,
                                    TMatcher matcher)
        {
            _values = new List<Smooth.Algebraics.Tuple<T1, T2, T3, T4>>
            {
                value
            };
            _recorder = recorder;

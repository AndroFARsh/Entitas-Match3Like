...
namespace Smooth.Foundations.PatternMatching
{
    ...
    public sealed class ExecMatcherAfterElse<T1, T2>
    {
        ...
        private readonly Smooth.Algebraics.Tuple<T1, T2> _value;

        internal ExecMatcherAfterElse(MatchActionSelector<T1, T2> selector,
                                     Action<T1, T2> elseAction, Smooth.Algebraics.Tuple<T1, T2> value)
        {
            _selector = selector;
            _elseAction = elseAction;
            _value = value;
    ...
    public sealed class ExecMatcherAfterElse<T1, T2, T3>
    {
        ...
        private readonly Smooth.Algebraics.Tuple<T1, T2, T3> _value;

        internal ExecMatcherAfterElse(MatchActionSelector<T1, T2, T3> selector,
                                      Action<T1, T2, T3> elseAction, Smooth.Algebraics.Tuple<T1, T2, T3> value)
        {
            _selector = selector;
            _elseAction = elseAction;
            _value = value;
    ...
    public sealed class ExecMatcherAfterElse<T1, T2, T3, T4>
    {
        ...
        private readonly Smooth.Algebraics.Tuple<T1, T2, T3, T4> _value;

        internal ExecMatcherAfterElse(MatchActionSelector<T1, T2, T3, T4> selector,
                                      Action<T1, T2, T3, T4> elseAction, Smooth.Algebraics.Tuple<T1, T2, T3, T4> value)
        {
            _selector = selector;
            _elseAction = elseAction;
            _value = value;

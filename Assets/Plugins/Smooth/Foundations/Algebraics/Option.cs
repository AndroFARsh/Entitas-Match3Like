...
namespace Smooth.Algebraics {
	...
	public struct Option<T> : IComparable<Option<T>>, IEquatable<Option<T>> {
		...
		/// </summary>
		public Option<T> ForEach(DelegateAction<T> action) { if (isSome) action(value);
			return this;
		}
		...
		/// </summary>
		public Option<T> ForEach<P>(DelegateAction<T, P> action, P p) { if (isSome) action(value, p); return this; }
		
		/// <summary>
		/// If the option isSome, invokes the someAction with the option's value; otherwise, invokes noneAction.
		/// </summary>
		public Option<T> ForEachOr(DelegateAction<T> someAction, DelegateAction noneAction) { if (isSome) someAction(value); else noneAction(); return this; }
		
		/// <summary>
		/// If the option isSome, invokes the someAction with the option's value and p; otherwise, invokes noneAction.
		/// </summary>
		public Option<T> ForEachOr<P>(DelegateAction<T, P> someAction, P p, DelegateAction noneAction) { if (isSome) someAction(value, p); else noneAction(); return this; }
		
		/// <summary>
		/// If the option isSome, invokes the someAction with the option's value; otherwise, invokes noneAction with p2.
		/// </summary>
		public Option<T> ForEachOr<P2>(DelegateAction<T> someAction, DelegateAction<P2> noneAction, P2 p2) { if (isSome) someAction(value); else noneAction(p2); return this; }
		
		/// <summary>
		/// If the option isSome, invokes the someAction with the option's value and p; otherwise, invokes noneAction with p2.
		/// </summary>
		public Option<T> ForEachOr<P, P2>(DelegateAction<T, P> someAction, P p, DelegateAction<P2> noneAction, P2 p2) { if (isSome) someAction(value, p); else noneAction(p2); return this; }
		...
		/// </summary>
		public T 
			ValueOr(DelegateFunc<T> noneFunc) { return isSome ? value : noneFunc(); }

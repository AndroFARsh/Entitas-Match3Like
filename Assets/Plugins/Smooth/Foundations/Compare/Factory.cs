...
namespace Smooth.Compare {
	public static class Factory {
		...
		/// </summary>
		public static Algebraics.Tuple<Expression, MethodInfo> ExistingComparer<T>() {
		...
		/// a MethodInfo for the comparer's Compare(T, T) method.
		/// </summary>
		public static Algebraics.Tuple<Expression, MethodInfo> ExistingComparer(Type type) {
			...
			return new Algebraics.Tuple<Expression, MethodInfo>(
				c,
		...
		/// </summary>
		public static Algebraics.Tuple<Expression, MethodInfo, MethodInfo> ExistingEqualityComparer<T>() {
		...
		/// a MethodInfo for the comparer's GetHashCode(T) method.
		/// </summary>
		public static Algebraics.Tuple<Expression, MethodInfo, MethodInfo> ExistingEqualityComparer(Type type) {
			...
			return new Algebraics.Tuple<Expression, MethodInfo, MethodInfo>(
				ec,

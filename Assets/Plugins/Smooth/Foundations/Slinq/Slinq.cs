...
namespace Smooth.Slinq {
	...
	public struct Slinq<T, C> {
		...
		/// </summary>
		/// <exception cref="System.NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public void Remove() {
			if (current.isSome) {
	...
	public static class Slinq {
		...
		/// </summary>
		public static Slinq<Algebraics.Tuple<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with) {
		...
		/// </summary>
		public static Slinq<Algebraics.Tuple<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, ZipRemoveFlags removeFlags) {
		...
		/// </summary>
		public static Slinq<Algebraics.Tuple<T, int>, ZipContext<int, FuncContext<int, int>, T, C>> ZipWithIndex<T, C>(this Slinq<T, C> slinq) {

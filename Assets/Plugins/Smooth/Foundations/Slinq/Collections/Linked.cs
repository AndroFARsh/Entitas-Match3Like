...
namespace Smooth.Slinq.Collections
{
    ...
    public class Linked<T> : IDisposable
    {
        ...
        private static Linked<T> pool = new Linked<T>();
...
//                DetectResetLoop(this);
    ...
    public class Linked<K, T> : IDisposable
    {
        ...
        private static bool DetectResetLoop(Linked<K, T> head)
        {
            Linked<K, T> slow = head, prefFast = head, fast = head;
            while (slow != null && fast?.next != null)
            {
                slow = slow.next;
                prefFast = fast.next;                
    ...
    public struct LinkedHeadTail<T> : IEquatable<LinkedHeadTail<T>>
    {
        ...
        public override string ToString()
        {
            ...
            while (pos != null)
            {
                builder.Append($"Item{item++}").Append(pos.value).Append(", ");
            }
    ...
    public static class Linked
    {
        ...
        public static LinkedHeadTail<T> Sort<T>(LinkedHeadTail<T> input, Comparison<T> comparison, bool ascending)
        {
            ...
            {
                if ((ascending
                        ? comparison(input.head.value, input.tail.value)
                        : comparison(input.tail.value, input.head.value)) <= 0)
                {
                    return input;
                }
                else
            ...
            else
            {
                ...
                return Merge(Sort(left, comparison, ascending), Sort(right, comparison, ascending), comparison,
                    ascending);
            }
        }
        ...
        /// Calling this method will invalidate the specified list and any variables containing its nodes.
        /// </summary>
        public static LinkedHeadTail<K, T> Sort<K, T>(LinkedHeadTail<K, T> input, Comparison<K> comparison,
            bool ascending)
        {
            if (input.count <= 1)
            {
            ...
            {
                if ((ascending
                        ? comparison(input.head.key, input.tail.key)
                        : comparison(input.tail.key, input.head.key)) <= 0)
                {
                    return input;
                }
                else
        ...
        /// </summary>
        public static LinkedHeadTail<T> Merge<T>(LinkedHeadTail<T> left, LinkedHeadTail<T> right,
            Comparison<T> comparison, bool ascending)
        {
            if (left.count == 0)
            {
                return right;
        ...
        /// Calling this method will invalidate the specified lists and any variables containing their nodes.
        /// </summary>
        public static LinkedHeadTail<K, T> Merge<K, T>(LinkedHeadTail<K, T> left, LinkedHeadTail<K, T> right,
            Comparison<K> comparison, bool ascending)
        {
            if (left.count == 0)
            {
                return right;
        ...
        /// Calling this method will invalidate the specified list and any variables containing its nodes.
        /// </summary>
        public static LinkedHeadTail<T> InsertionSort<T>(LinkedHeadTail<T> input, Comparison<T> comparison,
            bool ascending)
        {
            if (input.count <= 1)
            {
        ...
        /// Calling this method will invalidate the specified list and any variables containing its nodes.
        /// </summary>
        public static LinkedHeadTail<K, T> InsertionSort<K, T>(LinkedHeadTail<K, T> input, Comparison<K> comparison,
            bool ascending)
        {
            if (input.count <= 1)
            {
